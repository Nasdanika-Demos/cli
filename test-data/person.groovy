...
new org.nasdanika.common.Invocable() {
	...
	/**
	 * This method is invoked by the dynamic proxy's Callable.call() method. 
	 * The first argument is the proxy object - it can be used to resolve state or call other methods of the proxy.
	 */
	def invoke(Object... args) {
  		System.out.println(args);
  		System.out.println(element.getProperty("greeting") + " I have " + amountSupplier.get() + " dollars in my bank account. I'm so happy!!!");
